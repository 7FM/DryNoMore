...
namespace {
    static void enterSleepMode() {
        ...
        // when using async mode with the internal oscillator: 32.768kHz BUT the system clock needs to be at least 4 times higher... see page 126
        // 32.768 kHz / 1024 = 32 Hz -> 8 seconds... so in either case we do not gain any advantage compared to the watchdog solution...
        // Hence, abuse the watchdog timer with an additional uint16_t counter variable to run the moisture checks every X hours
